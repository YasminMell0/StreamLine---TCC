...
if(!empty($dados['dataPublicacao'])){
  ...
  P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil FROM cadastroprofissional P
   where esp_exp = 'Festa' AND P.ativo = '1'  ORDER BY P.data_cadProf DESC LIMIT $pagina, $itens_pagina;";
...
elseif(!empty($dados['avali'])){ 
  ...
  INNER JOIN avaliacoescliente E ON P.Id_prof = E.Id_prof where esp_exp = 'Festa' AND P.ativo = '1'  
...
elseif(!empty($dados['local'])){ 
  ...
  P.espTempo, P.esp_exp, P.biografia, P.data_nascimento, P.data_cadProf, P.contato, P.cep, P.numero_casa, 
  P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil FROM cadastroprofissional P
   where esp_exp = 'Festa' AND P.ativo = '1'  ORDER BY P.cidade and P.estado DESC LIMIT $pagina, $itens_pagina;";
  $consulta = $con->query($cons);
  ...
  P.espTempo, P.esp_exp, P.biografia, P.data_nascimento, P.data_cadProf, P.contato, P.cep, P.numero_casa, 
  P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil FROM cadastroprofissional P
   where esp_exp = 'Festa' AND P.ativo = '1'  ORDER BY P.preco_fixo DESC LIMIT $pagina, $itens_pagina;";
  $consulta = $con->query($cons);
  ...
  P.espTempo, P.esp_exp, P.biografia, P.data_nascimento, P.data_cadProf, P.contato, P.cep, P.numero_casa, 
  P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil FROM cadastroprofissional P
   where esp_exp = 'Festa' AND P.ativo = '1'  ORDER BY P.preco_fixo ASC LIMIT $pagina, $itens_pagina;";
  $consulta = $con->query($cons);
}
else{
  ...
  P.espTempo, P.esp_exp, P.biografia, P.data_nascimento, P.data_cadProf, P.contato, P.cep, P.numero_casa, 
  P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil FROM cadastroprofissional P
   where esp_exp = 'Festa' AND P.ativo = '1'  LIMIT $pagina, $itens_pagina;";
  $consulta = $con->query($cons);
  }
...
<body>
  ...
  <a href="../Home.html"><button type="button" id="btnVoltarHome" class="btnVoltarHome">
              ...
              <form action="festa.php" method="get" name="filtrobusca">
          ...
          <div class="col-md-5 col-sm-6 grid-margin stretch-card">
            <nav>
              <ul class="pagination d-flex justify-content-center flex-wrap pagination-rounded-flat pagination-success">
                <li class="page-item"><a class="page-link" href="festa.php?pagina=0" data-abc="true"><i class="fa fa-angle-left"></i></a>
                </li>
                <!-- numeração -->
                 <?php 
                for($i=0;$i<$num_paginas;$i++){ 
                  ...
                  ?>
                <li class="page-item active" ><a class="page-link" href="festa.php?pagina=<?php echo $i; ?>" data-abc="true"><?php echo $i+1; ?></a></li>
                <?php } ?>
                <?php } ?>
              <!-- Fim da numeração -->
                <li class="page-item"><a class="page-link" href="festa.php?pagina=<?php echo $num_paginas-1; ?>" data-abc="true"><i
