...
if (isset($_POST['btnPress'])) {
    ...
    $totalToken = mysqli_num_rows($sql_query);
        if($totalToken >= 1){
                ...
                header("Location: confirmarCadCli.php");
            }
        }
