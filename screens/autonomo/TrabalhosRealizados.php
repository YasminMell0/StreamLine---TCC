...
if(!empty($dados['dataPublicacao'])){
  ...
  A.profissao, S.preco_final, S.data_contratacao FROM servico S 
...
elseif(!empty($dados['avali'])){ 
  $cons = "SELECT C.Id_cli, C.nome_cli, C.genero, C.estado, C.cidade, C.foto_perfil, C.biografia,
  E.Avaliacao_cli,
  P.profissao, A.Avaliacao_cli, S.preco_final, S.data_contratacao FROM servico S 
...
elseif(!empty($dados['cid'])){ 
  $cons = "SELECT C.Id_cli, C.nome_cli, C.genero, C.estado, C.cidade, C.foto_perfil, 
  A.profissao, S.preco_final, S.data_contratacao FROM servico S 
  INNER JOIN cadastroprofissional A ON S.Id_prof = A.Id_prof 
  INNER JOIN cadastrocliente C ON S.Id_cli = C.Id_cli 
      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-faded" style="background-color: #152c40">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100">
          ...
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <form action="busca/buscaTrabalhosRealizados.php" method="GET" name="buscaAutonomo">
                  ...
                  <div class="col-md-4" id="infocima">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="Nome" id="Nome"
                        value="<?php echo $dado['nome_cli']; ?>" disabled />
                    </div>
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="TrabPendente" id="TrabPendente"
                        value="<?php echo $dado['profissao']; ?>" disabled />
                    </div>
                  </div>
                  <div class="col-md-4" id="infocima">
                    <div class="form-group">
                  ...
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="Cidade" id="Cidade"
                        value="<?php echo $dado['cidade']; ?>" disabled />
                    </div>
                  </div>
                  <div class="col-md-3" style="padding-top: 5px;">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="UF" id="UF"
                        value="<?php echo $dado['estado']; ?>" disabled />
                    </div>
                  </div>
                  <div class="col-md-12" style="padding-top: 4%; margin-bottom: 10px;">
                    <div class="form-group1">
                      ...
                      <textarea class="form-control" id="biografia" disabled
                        rows="3"><?php echo $dado['biografia']; ?></textarea>
                    </div>
                  </div>
                </div>
                <br>
