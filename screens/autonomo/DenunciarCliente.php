...
$cons = "SELECT C.Id_cli, C.nome_cli, C.foto_perfil, C.email_cli,
P.profissao, P.esp_exp, P.nome_prof, S.data_contratacao, O.quantidade_horas, O.estimativa_preco 
FROM servico S 
...
<body>
  ...
  <div class="container container-fluid" style="background-color: #f2f2f2; padding-top: 3.5%; min-height: 900px">
    ...
    <div class="card">
      <div class="card-body">
        <form method="post" action="../bd_conexao/denunciarCliente.php" id="form" name="form">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="hidden" class="form-control" name="email_cli" id="email_cli" value="<?php echo $email_cli;?>" />
