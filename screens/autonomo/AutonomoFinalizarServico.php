...
P.profissao, P.esp_exp, P.preco_fixo, P.nome_prof, S.quant_horas, E.Avaliacao_cli,
    ...
    <div class="card">
      <div class="card-body">
       <form method="post" action="AvaliacaoCliente.php" id="form" name="form">
          <div class="row">
            ...
            <div class="col-md-6" id="infocima" style="margin: 0;">
              <div class="form-group">
                ...
                <input type="text" class="form-control" required name="nomecli" id="Nome" value="<?php echo $nome; ?>" readonly />
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label class="label" for="Esp" style="margin-left: 3%">Esp. Selecionadas:</label>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="DataTrabalho" id="DataTrabalho" value="<?php $data = $da['data_aval_cli'];
                                                                                                                                echo date_format(new DateTime($data), 'd/m/Y'); ?>" disabled />
                              </div>
                            </div>
          ...
          <div class="buttons">
            <button type="submit" formaction="InicialAutonomoTrabPendentes.php" id="btnEntrar" class="btnEntrar">
              Cancelar
            </button>
