...
if ($consulta->num_rows > 0) {
    ...
    header('Location: dadosPessoaisAutonomo.php');
}
...
<div class="container-fluid">
    ...
    <div class="container">
        <div class="card-body">
            <form method="post" action="../bd_conexao/editAutonomoPessoais.php" id="form" name="form">
                <h3 style="padding-bottom: 2%; padding-top: 10%; font-family: Arial, Helvetica, sans-serif;">Dados Pessoais</h3>
                <div class="row">
                    <div class="col-md-5">
                        <center>
                            <img src="<?php echo '../autonomo/perfil/' . $perfil; ?>"  class="img-fluid" alt="user" 
                    ...
                    <div class="form-grouprow">
                        <div class="form-col" style="width: 65%;">
                            ...
                            <input type="text" class="form-control" required name="cidade" id="cidade" value="<?php echo $cidade ?>" />
                        </div>
                        <div class="form-col1" style="width: 30%;">
                            <label class="label" for="Estado" style="margin-left: 8%;">Estado:</label>
                            <input type="text" class="form-control" required name="estado" id="estado" value="<?php echo $estado ?>" />
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="label" for="Rua" style="margin-left: 3%;">Rua:</label>
                            <input type="text" class="form-control" name="rua" id="rua" />
                        </div>
                        <div class="form-group">
                            <label class="label" for="Bairro" style="margin-left: 3%;">Bairro:</label>
                    ...
                    <div class="form-grouprow">
                        <div class="form-col" style="width: 30%;">
                            ...
                            <input type="text" class="form-control" required name="numero_casa" id="numero_casa" value="<?php echo $numero_casa ?>" />
                        </div>
