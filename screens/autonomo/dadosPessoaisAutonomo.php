                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" required name="email_prof"
                                            id="email_prof" value="<?php echo $dado['email_prof']; ?>" disabled />
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required name="nome_prof" id="nome_prof"
                                            disabled value="<?php echo $dado['nome_prof']; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <label class="label" for="Cep" style="margin-left: 3%;">CEP:</label>
                                        <input type="text" class="form-control" required name="cep" id="cep" disabled
                                ...
                                <div class="form-grouprow">
                                    <div class="form-col" style="width: 30%;">
                                        ...
                                        <input type="text" class="form-control" required name="numero_casa"
                                            id="numero_casa" value="<?php echo $dado['numero_casa']; ?>" disabled />
                                    </div>
                                    <div class="form-col1" style="width: 65%;">
                                        <label class="label" for="Complemento"
                                            style="margin-left: 4%;">Complemento:</label>
                                        <input type="text" class="form-control" required name="complemento"
                                            id="complemento" value="<?php echo $dado['complemento']; ?>" disabled />
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="buttons">
                                <a href="editarDadosPessoaisAutonomo.php" id="btnEditar" class="btn btnEditar">
                                    Editar Informações
                                </a>
                            </div>
                            <br><br>
