...
if ($consulta->num_rows > 0) {
    while ($dados = mysqli_fetch_assoc($consulta)) {
        ...
        $tempo_exp = $dados['tempo_exp'];
        $espTempo = $dados['espTempo'];
...
$aval = mysqli_query ($con, "UPDATE `avaliacoesprofissional` SET `Id_prof`='$id_prof' WHERE Id_cli = '1' and nome_cli = 'Admin'");
...
<head>
    ...
    <title>Editar Perfil Autonomo</title>
</head>
...
<div class="container-fluid">
    ...
    <div class="container">
        <div class="card-body">
            <form method="post" action="../bd_conexao/editAutonomopublico.php" id="form" name="form" enctype="multipart/form-data">
                <h3 style="padding-bottom: 2%; padding-top: 10%; font-family: Arial, Helvetica, sans-serif;">Dados Públicos</h3>
                <div class="row">
                    <div class="col-md-5">
                    <div>
                    <img id="preview" name="preview" src="<?php echo '../autonomo/perfil/'  .$perfil; ?>" class="img-fluid" alt="user" 
                    style="width: 150px; height: 150px; object-fit: cover; margin-top: 3%; margin-bottom: 20%; border-radius: 50%; position: relative;">
                    <label for="perfil" name="imagem" id="imagem"><img src="../../img/camera.png" class="img-fluid" alt="user" style="width: 65px; position: absolute; margin-top: 1%; margin-bottom: 50%; right: 46%;" ></label>
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="nome_prof" id="nome_prof" value="<?php echo $nome ?>" />
                        </div>
                        <div class="form-group">
                            <label class="label" for="Email" style="margin-left: 3%;">Email:</label>
                            <input type="email" class="form-control" required name="email_prof" id="email_prof" value="<?php echo $email ?>" />
                        </div>
                    </div>
                    <div class="col-md-12" style="padding-top: 4%;">
                        <div class="form-group1">
                            <label class="label" for="Biografia" style="margin-left: 3%;">Biografia:</label>
                            <textarea class="form-control" name="biografia" id="biografia" rows="3"><?php echo $biografia ?></textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="label" for="Profissao" style="margin-left: 3%;">Profissão:</label>
                            <input type="text" class="form-control" required name="profissao" id="profissao" value="<?php echo $profissao ?>" />
                        </div>
                    </div>
                    <div class="form-grouprow">
                        <div class="form-col" style="width: 45%;">
                            <label class="label" for="TempExp" style="margin-left: 6%;">Tempo de Experiência:</label>
                            <input type="number" class="form-control" required name="tempo_exp" id="tempo_exp" value="<?php echo $tempo_exp ?>" />
                        </div>
                        <div class="form-col1" style="padding-top: 0.5%; width: 50%;">
                            <label class="label" for="SelectTempExp"></label>
                            <select class="form-select" required name="espTempo" id="espTempo" value="<?php echo $espTempo ?>">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-select" required name="genero" id="genero" value="<?php echo $genero ?>">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" required name="contato" id="contato" value="<?php echo $contato ?>" />
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="preco_fixo" id="preco_fixo" value="<?php echo $preco ?>" />
                        </div>
                    </div>
                </div>
                <br>
