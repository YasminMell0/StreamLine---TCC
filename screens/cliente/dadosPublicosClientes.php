                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="Nome" id="Nome" disabled value="<?php echo $dado['nome_cli']; ?>" />
                    </div>
                    <div class="form-group">
                      <label class="label" for="Email" style="margin-left: 3%;">Email:</label>
                      <input type="email" class="form-control" required name="Email" id="Email" disabled value="<?php echo $dado['email_cli']; ?>" />
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="Genero" id="genero" disabled value="<?php echo $dado['genero']; ?>">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="label" for="Telefone" style="margin-left: 3%;">Telefone:</label>
                      <input type="tel" class="form-control" required name="Telefone" id="contato" disabled value="<?php echo $dado['contato']; ?>" />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="label" for="LinkWhats" style="margin-left: 3%;">Link WhatsApp:</label>
                      <input type="url" class="form-control" required name="LinkWhats" id="link" disabled value="<?php echo $dado['link']; ?>" />
                    </div>
                  </div>
                </div>
                <br>
                <div class="buttons">
                  <a href="editarDadosPublicosClientes.php" id="btnEditar" class="btn btnEditar">
                    Editar Informações
                  </a>
                </div>
                <br><br>
