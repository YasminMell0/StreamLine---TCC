          ...
          <div class="card-body">
            <?php while ($dado = mysqli_fetch_assoc($consulta)) { ?>
              <form method="post" id="form" name="form">
                <h3 style="padding-bottom: 2%; padding-top: 10%; font-family: Arial, Helvetica, sans-serif;">Dados
                  Pessoais</h3>
                <div class="row">
                  <div class="col-md-5">
                    <center>
                      <img src="<?php echo 'perfil/' . $dado['foto_perfil']; ?>" class="img-fluid" alt="user" style="width: 150px; height: 150px; object-fit: cover; margin-top: 3%; margin-bottom: 5%; border-radius: 50%;">
                    </center>
                  </div>
                  <div class="col-md-7">
                    <div class="form-group">
                      <label class="label" for="Email" style="margin-left: 3%;">Email:</label>
                      <input type="email" class="form-control" required name="email" id="Email" value="<?php echo $dado['email_cli']; ?>" disabled />
                    </div>
                    <div class="form-group">
                      <label class="label" for="Senha" style="margin-left: 3%;">Senha:</label>
                      <input type="password" class="form-control" required name="senha" id="Senha" value="" disabled />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="cep" id="Cep" value="<?php echo $dado['cep']; ?>" disabled />
                    </div>
                  </div>
                  <div class="form-grouprow">
                    ...
                    <div class="form-col1" style="width: 30%;">
                      ...
                      <input type="text" class="form-control" required name="estado" id="Estado" value="<?php echo $dado['estado']; ?>" disabled />
                    </div>
                  </div>
                  ...
                  <div class="form-grouprow">
                    <div class="form-col" style="width: 30%;">
                      ...
                      <input type="text" class="form-control" required name="numero" id="Numero" value="<?php echo $dado['numero_casa']; ?>" disabled />
                    </div>
                    <div class="form-col1" style="width: 65%;">
                      <label class="label" for="Complemento" style="margin-left: 4%;">Complemento:</label>
                      <input type="text" class="form-control" required name="complemento" id="Complemento" value="<?php echo $dado['complemento']; ?>" disabled />
                    </div>
                  </div>
                </div>
                <br>
                <div class="buttons">
                  <a href="editarDadosPessoaisClientes.php" id="btnEditar" class="btn btnEditar">
                    Editar Informações
                  </a>
                </div>
                <br><br>
