...
if(!empty($dados['dataPublicacao'])){
  ...
  WHERE P.ativo = '1'  ORDER BY data_cadProf DESC LIMIT $pagina, $itens_pagina;";
...
elseif(!empty($dados['avali'])){ 
  ...
  INNER JOIN avaliacoesprofissional E ON P.Id_prof = E.Id_prof WHERE P.ativo = '1'
  ORDER BY E.Avaliacao_prof DESC LIMIT $pagina, $itens_pagina;";
  $consulta = $con->query($cons);
}
elseif(!empty($dados['local'])){ 
  $cons = "SELECT P.Id_prof, P.nome_prof, P.genero, P.profissao, P.tempo_exp, P.ativo,
  P.espTempo, P.esp_exp, P.biografia, P.data_nascimento, P.data_cadProf, P.contato, P.cep, P.numero_casa, 
  P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil, E.Avaliacao_prof FROM cadastroprofissional P
   WHERE P.ativo = '1' ORDER BY cidade and estado DESC LIMIT $pagina, $itens_pagina;";
  $consulta = $con->query($cons);
  ...
  P.espTempo, P.esp_exp, P.biografia, P.data_nascimento, P.data_cadProf, P.contato, P.cep, P.numero_casa, 
  P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil FROM cadastroprofissional P
   WHERE P.ativo = '1' ORDER BY preco_fixo DESC LIMIT $pagina, $itens_pagina;";
  $consulta = $con->query($cons);
  ...
  P.espTempo, P.esp_exp, P.biografia, P.data_nascimento, P.data_cadProf, P.contato, P.cep, P.numero_casa, 
  P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil FROM cadastroprofissional P
   WHERE P.ativo = '1' ORDER BY preco_fixo ASC LIMIT $pagina, $itens_pagina;";
  $consulta = $con->query($cons);
}
else{
...
P.espTempo, P.esp_exp, P.biografia, P.data_nascimento, P.data_cadProf, P.contato, P.cep, P.numero_casa, 
P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil FROM cadastroprofissional P
 WHERE P.ativo = '1' LIMIT $pagina, $itens_pagina;";
$consulta = $con->query($cons);
  }
...
P.espTempo, P.esp_exp, P.biografia, P.data_nascimento, P.data_cadProf, P.contato, P.cep, P.numero_casa, 
P.complemento, P.cidade, P.estado, P.link, P.preco_fixo, P.foto_perfil 
FROM cadastroprofissional P
INNER JOIN avaliacoesprofissional E ON P.Id_prof = E.Id_prof WHERE P.ativo = '1';")->num_rows;
      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-faded" style="background-color: #152c40">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100">
          ...
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <form action="buscaCliente/buscaAutonomo.php" method="GET" name="buscaAutonomo">
    ...
    <div class="card">
      ...
      while ($avali = mysqli_fetch_assoc($avaliacoes)) { 
        ...
        $aval_valor = $avali['AvaliacaoProf'];
          ...
          ?>
          <form method="post" action="ContratAutonomoOrcamento.php" id="form" name="form">
            <div class="row">
              <div class="col-sm-4">
                <div class="estrelas">
          ...
          <div class="col-md-5 col-sm-6 grid-margin stretch-card">
            <nav>
              <ul class="pagination d-flex justify-content-center flex-wrap pagination-rounded-flat pagination-success">
                <li class="page-item"><a class="page-link" href="contratacaoAutonomoCliente.php?pagina=0" data-abc="true"><i class="fa fa-angle-left"></i></a>
                </li>
                <!-- numeração -->
                 <?php 
                for($i=0;$i<$num_paginas;$i++){ 
                  ...
                  ?>
                <li class="page-item active" ><a class="page-link" href="contratacaoAutonomoCliente.php?pagina=<?php echo $i; ?>" data-abc="true"><?php echo $i+1; ?></a></li>
                <?php } ?>
                <?php } ?>
              <!-- Fim da numeração -->
                <li class="page-item"><a class="page-link" href="contratacaoAutonomoCliente.php?pagina=<?php echo $num_paginas-1; ?>" data-abc="true"><i
