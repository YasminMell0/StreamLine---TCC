...
if(!isset($_GET['busca'])){
    header("Location: ../TrabalhosPendentesCliente.php");
    exit;
}
$busca = "%".trim($_GET['busca'])."%";
$dbh = new PDO('mysql:host=localhost; dbname=streamline', 'root', '');
$sth = $dbh->prepare("SELECT P.Id_prof, P.nome_prof, P.genero, P.cidade, P.estado, P.profissao,
...
and S.Id_cli = $id_cli and P.nome_prof and P.ativo = 1
LIKE :busca OR P.profissao LIKE :busca OR P.esp_exp LIKE :busca LIMIT $pagina, $itens_pagina");
...
$num_total = $con->query("SELECT P.Id_prof, P.nome_prof, P.genero, P.cidade, P.estado, P.profissao,
  ...
  <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-faded" style="background-color: #152c40">
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100">
      ...
      <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
        <form action="buscaTrabalhosPendentes.php" method="GET" name="buscaAutonomo">
          ...
          <form method="POST" action="ClienteFinalizarServico.php" id="form" name="form">
            <div class="row">
              <div class="col-sm-4">
                ...
                <center>
                  <img src="<?php echo '../../autonomo/perfil/' . $resultados['foto_perfil'] ?>" class="img-fluid" alt="user" 
              ...
              <input type="hidden" class="form-control" name="autonomo" id="autonomo" value="<?php echo $resultados['Id_prof']; ?>" />
            </div>
            <div class="col-md-3" style="padding-top: 5px;">
              <div class="form-group">
              </div>
          ...
          <div class="col-md-5 col-sm-6 grid-margin stretch-card">
            <nav>
              <ul class="pagination d-flex justify-content-center flex-wrap pagination-rounded-flat pagination-success">
                <li class="page-item"><a class="page-link" href="buscaTrabalhosPendentes.php?pagina=0" data-abc="true"><i class="fa fa-angle-left"></i></a>
                </li>
                ...
                ?>
                  <li <?php echo $estilo; ?> class="page-item active"><a class="page-link" href="buscaTrabalhosPendentes.php?pagina=<?php echo $i; ?>" data-abc="true"><?php echo $i + 1; ?></a></li>
                <?php } ?>
                <!-- Fim da numeração -->
                <li class="page-item"><a class="page-link" href="buscaTrabalhosPendentes.php?pagina=<?php echo $num_paginas - 1; ?>" data-abc="true"><i class="fa fa-angle-right"></i></a></li>
              </ul>
            </nav>
          </div>
        </div>
