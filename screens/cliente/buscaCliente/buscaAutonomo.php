...
$sth = $dbh->prepare("SELECT P.Id_prof, P.nome_prof, P.genero, P.profissao, P.tempo_exp, P.ativo,
...
WHERE nome_prof = 'Rita Lee' and P.ativo = '1' AND P.nome_prof LIKE :busca OR profissao LIKE :busca OR esp_exp LIKE :busca  LIMIT $pagina, $itens_pagina");
...
<div class="row flex-nowrap">
  ...
  <div class="container">
    <!-- filtro -->
    <form action="../ContratacaoAutonomoCliente.php" method="get" name="filtrobusca">
        ...
        if(count($resultados)) {
          ...
          <div class="row">
                  <div class="col-sm-4">
                    ...
                    <center>
                      <img src="<?php echo '../../autonomo/perfil/' . $resultados['foto_perfil'] ?>"  class="img-fluid"
                        alt="user" style="width: 150px; height: 150px; object-fit: cover; margin-top: 3%; margin-bottom: 5%; border-radius: 50%;">
                    </center>
                  </div>
                  <div class="col-md-4" id="infocima">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="Nome" id="Nome"
                        value="<?php echo $resultados['nome_prof']; ?>" disabled />
                    </div>
                    <div class="form-group">
                      <label class="label" for="TrabPendente">Profissão:</label>
                      <input type="text" class="form-control" required name="TrabPendente" id="TrabPendente"
                        value="<?php echo $resultados['profissao']; ?>" disabled />
                    </div>
                  </div>
                  <div class="col-md-4" id="infocima">
                    <div class="form-group">
                      <label class="label" for="DataContract">Data de Cadastro:</label>
                      <input class="form-control" required name="DataContract" id="DataContract"
                        value="<?php echo date('d/m/Y', strtotime($resultados['data_cadProf'])); ?>" disabled />
                    </div>
                    <div class="form-group">
                      <label class="label" for="Preco">Preço Base:</label>
                      <input type="text" class="form-control" required name="Preco" id="Preco"
                        value="<?php echo $resultados['preco_fixo']; ?>" disabled />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group" style="padding-top: 3px;">
                      <label class="label" for="Gênero">Gênero:</label>
                      <input type="text" class="form-control" required name="Gênero" id="Gênero"
                        value="<?php echo $resultados['genero']; ?>" disabled />
                    </div>
                  </div>
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="Cidade" id="Cidade"
                        value="<?php echo $resultados['cidade']; ?>" disabled />
                    </div>
                  </div>
                  <div class="col-md-3" style="padding-top: 5px;">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="UF" id="UF"
                        value="<?php echo $resultados['estado']; ?>" disabled />
                    </div>
                  </div>
                  <div class="col-md-12" style="padding-top: 4%; margin-bottom: 10px;">
                    <div class="form-group1">
                      <label class="label" for="Biografia">Biografia:</label>
                      <textarea class="form-control" id="Biografia" disabled
                        rows="3"><?php echo $resultados['biografia']; ?></textarea>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-5 col-sm-6 grid-margin stretch-card">
            <nav>
              <ul class="pagination d-flex justify-content-center flex-wrap pagination-rounded-flat pagination-success">
                ...
                ?>
                  <li <?php echo $estilo; ?> class="page-item active"><a class="page-link" href="buscaAutonomo.php?pagina=<?php echo $i; ?>" data-abc="true"><?php echo $i + 1; ?></a></li>
                <?php } ?>
                <!-- Fim da numeração -->
