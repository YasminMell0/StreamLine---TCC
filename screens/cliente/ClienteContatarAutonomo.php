...
$horario_atual = date('H:i:s', time());
      ...
      if ($consulta->num_rows > 0) {
        while ($dados = mysqli_fetch_assoc($consulta)) {
          ...
          $orcamento = $dados['estimativa_preco'];
          ...
          $data_orcamento = $dados['data_contratacao'];
...
// AVALIAÇÕES
$avaliacoes = "SELECT A.nome_prof, A.data_aval_prof, A.Comentario_prof, A.Avaliacao_prof,
...
ON A.Id_cli = C.Id_cli
 WHERE A.Id_prof = $autonomo LIMIT 0,1;";
      ...
      <div class="card-body">
        <form method="post" action="" id="form" name="form">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" required name="orcamento" id="orcamento" value="<?php echo $orcamento; ?>" disabled />
              </div>
              <div class="form-group">
                <label class="label" for="DataCadastro" style="margin-left: 3%">Data de Cadastro:</label>
                <input class="form-control" required name="DataCadastro" id="DataCadastro" value="<?php echo date('d/m/Y', strtotime($dataCadastro)); ?>" disabled />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" required name="DataContrat" id="DataContrat" value="<?php echo date('d/m/Y', strtotime($data_orcamento)); ?>" disabled />
              </div>
            </div>
            <div class="col-md-8">
              <div class="form-group">
         ...
         <?php 
                          ...
                          <div class="row">
                            ...
                            <center>
                              ...
                              <label for="cm_star-1">  <?php echo substr($aval_val,0,3); ?>  <i class="fa"></i></label>
                                ...
                                <img src="<?php echo '../autonomo/perfil/' . $da['foto_perfil']; ?>" class="img-fluid" alt="user" style="
                                        width: 150px; height: 150px; object-fit: cover;
                                        background: #182b3d;
                                        margin-top: 3%;
                                        margin-bottom: 5%;
          ...
          <input type="hidden" class="form-control" name="cli" id="cli" value="<?php echo $cli; ?>" />
          ...
          <div class="buttons">
            ...
            <a href="<?php echo $link; ?>"><button id="btnPress" class="btnPress">
                Entrar em Contato
              </button>
          </div>
        </form>
